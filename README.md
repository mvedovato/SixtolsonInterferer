...
_Genera dos PWMs independientes en OUT0 y OUT1. Cuando OUT0 genera el pwm, OUT1 está en 0 y viceversa (cada 10 ms)._
1. La solución más sencilla funciona correctamente salvo que en los casos de 0% y 100% agrega picos que deforman la forma de onda final. El caso 100% se corrige poniendo un duty mayor al 100%. Para el 0% no hay solución elegante.

2. Con el ejemplo de AN11538 Two-channel PWM los casos 0% y 100% no parecen generar picos.
Pruebas realizadas:
...
- Inversor con PWM 1 paso (pwm freq 50Hz -> 100% y 0%, señal cuadrada -> circuito con TL494):
