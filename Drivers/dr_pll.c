...
void Inicializar_PLL( void )
{
	...
	//SYSCON->SYSPLLCTRL               = 0x23;      // MSEL=3 PSEL=1 -> M = 4, P = 2 48MHz
	//SYSCON->SYSPLLCTRL               = 0x02;      // MSEL=2 PSEL=0 -> M = 3, P = 1 36MHz
	SYSCON->SYSPLLCTRL               = 0x01;      // MSEL=1 PSEL=0 -> M = 2, P = 1 24MHz


	//main_clk = fro * (MSEL + 1) / P = 12MHz *(3+1)/2
	//main_clk = 24Mhz
